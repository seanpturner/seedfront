...
function BulkUpdate() {
    ...
    const getOpenPurchases = () => {
        ...
        fetch("https://www.boutiqueseedsnm.com/purchases/openpurchases", requestOptions)
    ...
    const getAllStatuses = () => {
        ...
        fetch("https://www.boutiqueseedsnm.com/purchasestatuses", requestOptions)
            .then(response => response.json())
    ...
    const updatePurchase= (order) => {
        ...
        fetch('https://www.boutiqueseedsnm.com/purchases/' + order.id, requestOptions)
