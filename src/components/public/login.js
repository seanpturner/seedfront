...
function Login() {
    ...
    const checkUserName = (name) => {
        let requestOptions = {
            ...
            fetch("https://www.boutiqueseedsnm.com/users/user/" + name, requestOptions)
    ...
    const baseUrl = 'https://www.boutiqueseedsnm.com/users/getToken/';
    ...
    const addNewUser = () => {
        ...
        fetch("https://www.boutiqueseedsnm.com/users", requestOptions)
        .then(response => response.text())
